...
read_write_func timeServer[MAX_NUM_OPS][MAX_NUM_MODS][MAX_NUM_PROP] =
    {
        ...
        //[Write][ClkClock][ClkClockSeconds] = readClkClockSeconds,
        //[Write][ClkClock][ClkClockNanoseconds] = readClkClockNanoseconds,
        ...
        //[Write][ClkClock][ClkClockDrift] = readClkClockDrift,
        //[Write][ClkClock][ClkClockDriftInterval] = readClkClockDriftInterval,
        //[Write][ClkClock][ClkClockDriftAdj] = readClkClockDriftAdj,
        //[Write][ClkClock][ClkClockOffset] = readClkClockOffset,
        //[Write][ClkClock][ClkClockOffsetInterval] = readClkClockOffsetInterval,
        //[Write][ClkClock][ClkClockOffsetAdj] = readClkClockOffsetAdj,
