...
char *NtpServerProperties[] = {
    [NtpServerVersion] = "version",
    [NtpServerInstanceNumber] = "instance",
    [NtpServerMacAddress] = "mac",
    [NtpServerVlanAddress] = "vlan_address",
    [NtpServerVlanStatus] = "vlan_status",
    [NtpServerIpMode] = "ip_mode",
    [NtpServerIpAddress] = "ip_address",
    [NtpServerUnicastMode] = "unicast_mode",
    [NtpServerMulticastMode] = "multicast_mode",
    [NtpServerBroadcastMode] = "broadcast_mode",
    [NtpServerStatus] = "status",
    [NtpServerStratumValue] = "stratum",
    [NtpServerPollIntervalValue] = "poll_interval",
    [NtpServerPrecisionValue] = "precision",
    [NtpServerReferenceIdValue] = "reference_id",
    [NtpServerLeap59Status] = "leap59",
    [NtpServerLeap59InProgress] = "leap59_inprogress",
    [NtpServerLeap61Status] = "leap61",
    [NtpServerLeap61InProgress] = "leap61_inprogress",
    [NtpServerUtcSmearingStatus] = "utc_smearing",
    [NtpServerUtcOffsetStatus] = "utc_offset_status",
    [NtpServerUtcOffsetValue] = "utc_offset_value",
    [NtpServerRequestsValue] = "requests",
    [NtpServerResponsesValue] = "responses",
    [NtpServerRequestsDroppedValue] = "requests_dropped",
    [NtpServerBroadcastsValue] = "broadcasts",
    [NtpServerClearCountersStatus] = "clear_counters",
    [27] = "NULL",
};
