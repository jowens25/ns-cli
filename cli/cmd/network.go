...
var networkCmd = &cobra.Command{
	Use:     "network",
	Aliases: []string{"net"}, // Define aliases here
...
var connectCmd = &cobra.Command{
	Use:   "connect",
	Short: "connect lan port",

	Run: func(cmd *cobra.Command, args []string) {
		lib.PortConnect(lib.AppConfig.Network.Interface)
		fmt.Println(lib.GetPortConnectionStatus(lib.AppConfig.Network.Interface))
	},
}

var disconnectCmd = &cobra.Command{
	Use:   "disconnect",
	Short: "disconnect lan port",
...
var nmCmd = &cobra.Command{
	Use:   "nm [netmask]",
	Short: "get and set netmask address",

	Run: func(cmd *cobra.Command, args []string) {

		if len(args) == 1 {
			lib.SetNetmask(lib.AppConfig.Network.Interface, args[0])
...
func init() {
	...
	networkCmd.AddCommand(nmCmd)

	networkCmd.AddCommand(connectCmd)
	networkCmd.AddCommand(disconnectCmd)
